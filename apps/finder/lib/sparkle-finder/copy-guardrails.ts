...
const BANNED_COPY_RULES: SparkleFinderCopyRule[] = [
  ...
  { phrase: "board context", pattern: /\bboard\s+context\b/i },
  { phrase: "board data", pattern: /\bboard\s+data\b/i },
  { phrase: "board detail", pattern: /\bboard\s+details?\b/i },
  { phrase: "board shortcut", pattern: /\bboard\s+shortcuts?\b/i },
  { phrase: "board inventory", pattern: /\bboard\s+inventory\b/i },
  { phrase: "board match", pattern: /\bboard\s+matches?\b/i },
  { phrase: "board path", pattern: /\bboard\s+paths?\b/i },
  { phrase: "board link", pattern: /\bboard\s+links?\b/i },
