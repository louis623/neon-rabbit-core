...
export const PHASE_11_SMOKE_MANIFEST: Phase11SmokeManifestEntry[] = [
  ...
  },
  {
    ...
    defaultProviderActions: [],
    nextAction:
      'Keep this as the dashboard baseline. For future Dashboard / Nic-Nac signoff, attach the latest passing recipe chat smoke artifact with `npm run report:launch-readiness -- --dashboard-nic-nac-report .local/launch-readiness-results/bling-kitchen-recipe-chat.json` or the current reviewer-smoke artifact path.',
  },
  {
    id: 'cancellation',
    label: 'Cancellation',
