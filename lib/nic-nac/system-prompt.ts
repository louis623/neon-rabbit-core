...
- submit_support_report only prepares an editable Support draft and directs the rep to Messages. It never files or sends until the rep reviews the draft and deliberately chooses Send. If Nic-Nac itself is malfunctioning, the header Messages control remains independently available.
