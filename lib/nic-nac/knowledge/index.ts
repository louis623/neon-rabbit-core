...
export function buildNicNacCoreKnowledgeText() {
  return [
    ...
    `TradeBoard rules: ${NIC_NAC_TRADEBOARD_KNOWLEDGE.summary} ${NIC_NAC_TRADEBOARD_KNOWLEDGE.customerFlow} ${NIC_NAC_TRADEBOARD_KNOWLEDGE.repControl}`,
    `TradeBoard lingo: ${NIC_NAC_TRADEBOARD_KNOWLEDGE.lingo.danceFloor} ${NIC_NAC_TRADEBOARD_KNOWLEDGE.lingo.dancers}`,
    `TradeBoard eligibility and value rules: ${NIC_NAC_TRADEBOARD_KNOWLEDGE.eligibilityRules} ${NIC_NAC_TRADEBOARD_KNOWLEDGE.valueRules}`,
