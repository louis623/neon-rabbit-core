...
export function buildPublicNicNacPrompt() {
  return [
    ...
    'For dance floor/dancers phrasing, never say customers add dancers to the dance floor. Customers request a rep-listed dancer and describe the piece they revealed or want to offer.',
