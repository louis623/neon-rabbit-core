...
**Version:** 1.3 | **Created:** May 2, 2026 | **Status:** IN PROGRESS
...
**Use Case Note:** Louis sees this for rep site blocks — "about me" (front: photo/name, back: bio/contact), "book a party" (front: teaser, back: details), collection highlights (front: name, back: contents). Louis spotted the Amber color match immediately.
**Key Features:** Full Y-axis flip on hover (`rotateY(180deg)`). 0.8s transition. `perspective: 1000px`, `transform-style: preserve-3d`, `backface-visibility: hidden`. Front face: warm gradient (bisque → peach → coral). Back face: inverse warm gradient (coral-dominant). 1rem border-radius. Coral border on both faces. Box shadow on both faces.
**Vibe:** Warm, energetic, interactive. The flip mechanic adds a reveal/discovery feel.
**Kit Recommendation:** Amber — Louis called it. Coral/bisque tones map almost perfectly to Amber palette (#F97316 primary, #761A00 accent, #FFB781 border, #FAFAFA bg). Melodrama heading on front face, Nunito body on back. Gradient stops → bisque becomes #FAFAFA, coral becomes #F97316, deeper coral becomes #761A00.
...
## Components #5+ — (Awaiting Louis's next finds)
