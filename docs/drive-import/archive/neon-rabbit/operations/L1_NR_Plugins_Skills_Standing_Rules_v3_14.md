...
**Version:** 3.14 | **Last Updated:** April 19, 2026 | **Principles:** KISS. Future-Forward. One-Man + AI.
...
Triggered by: April 19 Phase 2 mapping kickoff session. Louis proposed Rule 28. Rule 26 contradiction surfaced during Rule 28 design. Learning loop architecture designed to let Claude actually improve across sessions. All three rules stress-tested in-session before codification.
...
**Rule 28 — 95% Confidence Before Execution (NEW — April 19, 2026)**
...
**Rule 29 — Claude's Learning Loop (NEW — April 19, 2026)**
...
**Session open protocol — fifth pull added:**
...
**Connects to:** Rule 9 (session close file generation), Rule 10 (context monitoring), Rule 24 (tooling awareness list uses similar surface-when-relevant pattern), Rule 30 (rule revision discipline).

**Rule 30 — Rule Revision Discipline (NEW — April 19, 2026)**
...
**Connects to:** Rule 9 (session close file generation), Rule 29 (learning loop capture behavior), all existing Standing Rules (this rule governs how they change over time).
