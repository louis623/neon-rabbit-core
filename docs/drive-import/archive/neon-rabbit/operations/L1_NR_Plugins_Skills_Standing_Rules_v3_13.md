...
**Version:** 3.13 | **Last Updated:** April 19, 2026 | **Principles:** KISS. Future-Forward. One-Man + AI.

**v3.13 CHANGES (April 19, 2026):** Added Rule 27 (Prompt Format: Execution Instructions Live Outside the Prompt) and Rule 16 clarification. Triggered by Gate 0 Item 4 prompt cycle — EXECUTION block kept getting embedded inside the copy-pasted Claude Code prompt instead of being instructions to Louis delivered above it. This version also carries forward Rule 25 (Fix It, Don't Surface It) and Rule 26 (Engineering Team vs CEO Decision Rights) from v3.12 (April 18 HQ session) which was in Drive but never propagated into the Claude project.
...
**Rule 25 — Fix It, Don't Surface It (April 18, 2026)**
...
**Rule 26 — Engineering Team vs CEO Decision Rights (April 18, 2026)**
...
Connects to: Rules 2 (KISS), 3 (One-Man + AI Partnership), 14 (Concise Communication), 21 (Best Work First), 23 (Code Executes, Louis Decides), 25 (Fix It, Don't Surface It).

**Rule 27 — Prompt Format: Execution Instructions Live Outside the Prompt (April 19, 2026)**
