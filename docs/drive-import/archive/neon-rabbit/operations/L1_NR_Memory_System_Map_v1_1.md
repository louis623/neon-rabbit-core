...
**Version:** 1.1 | **Created:** April 19, 2026 | **Last Updated:** April 19, 2026 | **Status:** LOCKED
...
## Session Open Protocol (memory-relevant pulls — UPDATED TO 6)

From SOP v1.11 — the six pulls that hydrate memory at session start:
...
5. **Scoped `CLAUDE —` engineering pull** — threshold 0.4, limit 5, max 2 domains per session — Rule 29 learning loop retrieval
