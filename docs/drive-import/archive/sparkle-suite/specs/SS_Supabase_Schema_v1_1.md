...
**Version:** 1.1 | **Created:** April 11, 2026 | **Last Updated:** April 19, 2026 | **Status:** LIVE — Phase 0 shipped, schema reflects deployed reality
...
This schema defines all 17 Supabase tables for the Sparkle Suite platform. It is the single source of truth for Phase 0 Task 0.2 (create all tables + RLS policies). Every table, column, relationship, enum, and index is specified here.
