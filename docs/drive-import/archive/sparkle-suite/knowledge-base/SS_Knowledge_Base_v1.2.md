...
**Version:** 1.2 | **Created:** April 7, 2026 | **Last Updated:** April 7, 2026 | **Status:** WORKING DRAFT — Building toward SS_Master_Plan_v1.0
...
**Option B (Custom/Standalone) pricing:** Still a premium because of additional customization work, but it's about the WORK involved, not a different product tier. Pricing model TBD.
...
### Unified Site Architecture (Decided/Clarified April 7, 2026)

**Both Option A and Option B live within the same yoursparklesuite.com architecture.** There are NOT two separate deployment models. It's ONE platform with two levels of customization.
...
**Option B — Custom (Premium)**
- ALSO lives within yoursparklesuite.com — NOT a separate deployment
- Same domain forwarding approach
- The DIFFERENCE is modularity: Option B clients get additional customization within the platform
- Architecture must be modular enough to add/remove/customize sections for multi-brand reps
- For: Reps who do more than Bomb Party (Heather = cooking show, Bri = Sensi/beauty affiliates)
- Premium pricing because more customization work, but SAME infrastructure

**Implication:** Vercel hosts ONE application with many custom domains pointing to it. Not 100 separate deployments. Simpler, cheaper, easier to maintain.
...
- AI auto-enhances photo to catalog quality (third-party service — see Section 14.5)
...
### Research Needed
- How do value tiers work in practice in the Bomb Party community? (Need rep Q&A)
...
3. **Identifies rarity and values** — the more data, the better understanding of what's common vs rare.
...
6. **Intelligence value** — data on what pieces exist, how often they appear, what they trade for.
...
6. 🔲 Bomb Party jewelry database (concept decided, builds via trade board usage)
...
- Platform architecture decided (unified yoursparklesuite.com, both Option A and B)
...
- Bomb Party jewelry database as byproduct of trade board
...
- Bomb Party jewelry database — unique data asset nobody else has
...
|------|----------------|-------------|
| AI Show Assistant (standalone) | Too vague, no clear pain points defined, TikTok integration unlikely | Absorbed by chatbot concept — voice-enabled chatbot during shows IS the assistant. Revisit if new pain points surface from active users that the chatbot can't address. |
...
| Jewelry library (as standalone feature) | What is it beyond the trade board database? Who maintains it? | After trade board and jewelry database are built — may be the same thing |
...
- ~~Site architecture (A vs B)~~ → Unified architecture decided
...
**Product Definition:**
- OQ-8: Jewelry library — what is it beyond the trade board database? Who maintains it?
...
- OQ-17: Option B premium pricing model (now about custom WORK pricing, not a different tier)
...
- Trade board value tiers in the Bomb Party community (rep Q&A needed)
...
| Jewelry library | ❌ Not yet covered | — |
...
| Customer homepage design | ❌ Not yet covered | — |
| Rep homepage design | ❌ Not yet covered | — |
...
|----------|----------|--------|
| SS_Knowledge_Base_v1.2.md (this file) | Google Drive /Neon Rabbit/ | Living reference ✅ |
