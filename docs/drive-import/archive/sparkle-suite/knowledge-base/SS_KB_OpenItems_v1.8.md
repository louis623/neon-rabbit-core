...
**Version:** 1.8 | **Derived from:** SS_KB_OpenItems_v1.7 | **Last Updated:** April 9, 2026
**Status:** Gap Analysis Session #18 complete. ALL legal sprints L1–L6 RESEARCH COMPLETE with all decisions made. Gap 21 resolved (trade request form). Gap 23 resolved (live show notifications). Universal cancellation policy decided. Forever tier eliminated. Two gaps remain open (20, 22).

**COMPANION MODULES:**
- SS_KB_Core_v1.8.md — Architecture, strategy, business model, decisions
...
**Resolved Sessions #9–18:** 16 closed + 4 deferred + 1 partially resolved
**Remaining open:** 2 (Gap 20, Gap 22)
**Categories 2–5:** COMPLETE as of Session #11

### Resolved Gaps (Sessions #9–18)
...
4. ~~Monthly + quarterly cancellation policy~~ → REPLACED by universal cancellation policy (Session #18).
...
25. ~~Gap 21 Customer-facing trade request form~~ → RESOLVED (Session #18). Simple form: name + description + submit. No MSRP field. Rep is value gatekeeper.
26. ~~Gap 23 Thumper live show notification mechanism~~ → RESOLVED (Session #18). Thumper conversation on laptop/PC + push notification backup. TikTok chat = rep-to-customer channel. Desktop-first design.
...
|---|-----|--------|--------|-------|
| 20 | BP item number / style name confirmation | Ask Lindsey | OPEN — BLOCKING | Do BP pieces consistently have an item number or style name on the reveal box/tag? Determines whether dedup is simple (item number match) or complex (multi-attribute fuzzy matching). Also affects Gap 22 tool schemas. |
| 22 | Thumper trade board tool definitions | Opus design session (~30–45 min) | OPEN — PARKED until Gap 20 answered | Specific tool schemas (parameters, return values, error handling). Must be done before Claude Code. Gap 20 answer affects tool parameters. |

**Dependencies:** Gap 20 (item number) must be answered FIRST — it affects Gap 22. Gap 22 is the last design item before the prototype build can begin.

---

## Legal Research Sprint Queue — ALL COMPLETE
...
| # | Item | Method | Status |
|---|------|--------|--------|
| L1 | Service agreement best practices for SaaS | Gemini deep research | ✅ RESEARCH COMPLETE |
| L2 | FTC income claim compliance for MLM recruitment pages | Gemini deep research | ✅ RESEARCH COMPLETE |
| L3 | Bomb Party trademark usage on a commercial platform | Gemini deep research | ✅ RESEARCH COMPLETE |
| L4 | ToS + Privacy Policy boilerplate | Gemini deep research | ✅ RESEARCH COMPLETE |
| L5 | Trade board listing-only platform liability disclaimer | Gemini deep research | ✅ RESEARCH COMPLETE |
| L6 | Annual + Forever cancellation/refund policy standards | Gemini deep research | ✅ RESEARCH COMPLETE — Session #18. Universal cancellation policy decided. Forever tier eliminated. |
...
- IRS barter exchange classification: attorney opinion needed before launch — ATTORNEY AGENDA ITEM
...
**L6 — Annual + Lifetime Cancellation (Session #18):**
- ROSCA compliance: clear disclosure, express consent, simple cancellation — all satisfied by universal policy
- FTC Click-to-Cancel: self-service online cancellation — satisfied
- Florida § 501.165: 30-day renewal notice for annual plans — build requirement
...
- Clickwrap at checkout with clear cancellation terms
- Forever/Lifetime tier eliminated — KISS principle. Legal complexity disproportionate to revenue benefit.
- Universal cancellation policy: cancel anytime, service through end of current month, pro-rata refund for unused time

---

## Build Requirements from Legal Sprints (Sessions #17–#18)
...
| Self-service cancellation button in dashboard | L6 | Rep dashboard |
| Automated pro-rata refund via Stripe | L6 | Billing system |
| 30-day renewal reminder email for annual plans | L6 | Automation |
| 7–30 day renewal reminder (Visa/Mastercard) | L6 | Automation |
| Login/usage logging for chargeback defense (CE 3.0) | L6 | Platform infrastructure |
| Clear cancellation terms at checkout clickwrap | L6 | Checkout flow |
...
- Platform subscription pricing (monthly/quarterly/annual amounts)
...
- Thumper trade board tool schemas (Gap 22 — Opus session, parked until Gap 20 answered)
...
| Thumper as rep-customer relay during shows | PARKING LOT | Post-launch. Would need customer-facing communication channel design. |
| Trade value based on purchase price vs MSRP | PARKING LOT | Considered Session #18, rejected — stick with MSRP (community standard). Revisit if reps request. |
...
12. Rep screen real estate during live shows — resolved via two-device setup recommendation (Session #18)
