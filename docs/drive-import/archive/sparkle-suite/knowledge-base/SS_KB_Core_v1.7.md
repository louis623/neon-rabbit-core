...
**Version:** 1.7 | **Derived from:** SS_KB_Core_v1.6 | **Last Updated:** April 9, 2026
**Status:** WORKING — updated with Session #17 decisions (Legal sprints L1–L5 research complete, key build requirements identified, attorney session agenda compiled)

**COMPANION MODULES:**
- SS_KB_SiteSpec_v1.0.md — Full site template spec (all 4 pages + design system)
- SS_KB_OpenItems_v1.7.md — Open questions, research sprint, gap analysis, parking lot
...
## Legal Framework — Research Complete (Sessions #17)

Legal sprints L1–L5 research complete. L6 (annual + forever cancellation) carries to next session. All findings captured to Open Brain. Attorney drafts final language from this foundation.
...
All items carry forward until attorney session is scheduled:
...
| 7 | IRS barter exchange classification opinion | L5 | New item — does trade board = barter exchange? |
| 8 | Annual + forever cancellation policy | L6 | After L6 research complete |

---

## Trade Board — Decided (Session #16)
...
**Live show trade flow:**
1. Customer browses trade board, picks piece, enters their MSRP, submits
2. Thumper pings rep in real time
3. Rep approves/rejects with quick tap
4. Approved = piece disappears immediately. No "reserved" status.
5. Post-show: Thumper walks rep through batch processing

**Value matching:** Equal or lesser MSRP. Rep-configurable tolerance. Customer self-reports from box. Rep verifies post-show.
...
**Scope:** Trade board + Thumper + customer-facing reserve flow + real-time notifications.

**Pre-build blockers (Gaps 20–23):** All four must be resolved before Claude Code begins.
