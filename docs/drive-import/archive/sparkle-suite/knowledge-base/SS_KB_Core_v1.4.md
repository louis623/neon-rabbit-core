...
**Version:** 1.4 | **Derived from:** SS_KB_Core_v1.3 | **Last Updated:** April 9, 2026
**Status:** WORKING — updated with Session #14 decisions (AI photo enhancement vendor, photo QA architecture, rep photography kit, voice deferred, Thumper agent architecture flagged as open)

**COMPANION MODULES:**
- SS_KB_SiteSpec_v1.0.md — Full site template spec (all 4 pages + design system)
- SS_KB_OpenItems_v1.4.md — Open questions, research sprint, gap analysis, parking lot
...
**Technical implementation:** Claude API. Default model: Haiku 4.5 for routine interactions. Escalates to Sonnet 4.6 for content screening, complex scheduling, and onboarding flows. Prompt caching on system prompt from day one.

**Agent architecture (OPEN — Session #14):** How Thumper executes actions, manages tools, connects to Supabase, and maintains conversation context has NOT been designed. Dedicated session required — Opus recommended given technical complexity.
...
**All legal items = research sprints.** No legal language written without a Gemini research sprint first. See SS_KB_Legal module and SS_KB_OpenItems_v1.4 legal sprint queue.
