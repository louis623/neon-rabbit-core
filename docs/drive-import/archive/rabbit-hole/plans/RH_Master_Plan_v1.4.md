...
**Version:** 1.4 | **Created:** April 5, 2026 | **Last Updated:** April 6, 2026 | **Status:** ACTIVE
...
- pgvector enabled on neon-rabbit-core — ready for Gate 2 semantic search (confirmed Research #5)
...
**Payment strategy (Research #3 and #6 findings):** Two competing recommendations that need resolution at decision round:
...
- See OD-26 for resolution. Crypto/stablecoin payments under research (Research #8).
...
| 5 | Memory/Capture Feature Landscape | ✅ Complete — analyzed | Open Brain + RH_Research_05 (generate for Drive) |
| 6 | Android-First vs. Simultaneous Launch | ✅ Complete — analyzed | Open Brain + RH_Research_06 (generate for Drive) |
| 7 | Agent-Friendly Architecture | Prompt drafted — ready to send to Gemini | — |
| 8 | Alternative Distribution + Crypto Payments | Prompt drafted — ready to send to Gemini | — |
...
| OD-26 | US anti-steering payment strategy — Stripe web checkout (0% commission, temporary) vs. native IAP (15%, permanent) vs. both | Legal timeline uncertainty + Research #3 tension | Decision round |
...
| RG-12 | What does agent-friendly architecture look like for consumer apps in 2026? | Research #7 — Agent-Friendly Architecture | Prompt drafted, ready to send |
| RG-13 | What are viable alternatives to app store distribution and traditional payment processing? | Research #8 — Alternative Distribution + Crypto Payments | Prompt drafted, ready to send |
