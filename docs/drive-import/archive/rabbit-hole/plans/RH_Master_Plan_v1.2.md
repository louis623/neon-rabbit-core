...
**Version:** 1.2 | **Created:** April 5, 2026 | **Last Updated:** April 6, 2026 | **Status:** ACTIVE
...
**Pricing:** TBD — needs dedicated pricing session. Must factor in Apple's 15% cut. See Research #3 (financial modeling) in progress.
...
| OD-3 | Offline-first caching — include in Gate 1? Which engine (Isar vs. Drift)? | Research #2 recommends Isar; Research #4 (onboarding) may inform scope | After all research complete |
...
| OD-6 | Gate 1 pricing — one-time purchase price point | Research #3 (financial modeling) | After Research #3 + pricing session |
| OD-7 | Gate 2 pricing — memory/capture purchase price | Research #3 + #5 (memory landscape) | After Research #3 + #5 |
| OD-8 | Gate 3 pricing — AI connect fee | Research #3 + dedicated planning session | After Research #3 + planning session |
| OD-9 | Caching architecture — Supabase-only for MVP vs. Redis (Upstash) from day one | Scale projections from Research #3 | After Research #3 |
...
|---|---|---|---|
| RG-1 | What does it cost per user per month at various scales? | Research #3 — financial modeling | Prompt sent to Gemini |
| RG-2 | How do non-technical users onboard to feed reader apps? | Research #4 — onboarding patterns | Prompt sent to Gemini |
| RG-3 | What does the memory/capture feature landscape look like? | Research #5 — competitive analysis | Prompt not yet drafted |
| RG-4 | Should we launch Android-first or simultaneous? | Research #6 — platform launch strategy | Prompt not yet drafted |
