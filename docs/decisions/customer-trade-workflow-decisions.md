...
## Archived Decision 1: Trading Eligibility
...
- Silver accounts can list trade-eligible items and initiate trade proposals, subject to the rest of the trade workflow rules, if customer-to-customer trading is reactivated later.
