...
export function AccountingDashboard({
  ...
  const metrics: Metric[] = [
    ...
    },
    {
      ...
      status: snapshot?.projectedExpensesCents == null ? 'Not connected' : 'Lane verified',
