...
export function DashboardPlaceholder() {
  ...
  async function loadAudience(signal?: AbortSignal) {
    const response = await fetch('/api/thumper/customer-audience?limit=25', {
      credentials: 'include',
      signal,
    })
    if (!response.ok) {
  ...
  async function loadWallet(signal?: AbortSignal) {
    const response = await fetch('/api/thumper/wallet-summary?limit=5', {
      credentials: 'include',
      signal,
    })
    if (!response.ok) {
  ...
  async function loadCalendar(signal?: AbortSignal) {
    const response = await fetch('/api/thumper/calendar-summary?upcoming=8&history=4', {
      credentials: 'include',
      signal,
    })
    if (!response.ok) {
  ...
  async function loadSiteSettings(signal?: AbortSignal) {
    const response = await fetch('/api/thumper/site-settings', {
      credentials: 'include',
      signal,
    })
    if (!response.ok) {
  ...
  async function loadAccountBilling(signal?: AbortSignal) {
    const response = await fetch('/api/thumper/account-billing', {
      credentials: 'include',
      signal,
    })
    if (!response.ok) {
  ...
  async function loadTradeBoard(signal?: AbortSignal) {
    const response = await fetch('/api/thumper/trade-board?limit=12', {
      credentials: 'include',
      signal,
    })
    if (!response.ok) {
  ...
  async function loadTradeRequests(signal?: AbortSignal) {
    const response = await fetch('/api/thumper/trade-requests?status=pending&limit=8', {
      credentials: 'include',
      signal,
    })
    if (!response.ok) {
  ...
  async function loadFulfillmentQueue(signal?: AbortSignal) {
    const response = await fetch('/api/thumper/fulfillment-queue', {
      credentials: 'include',
      signal,
    })
    if (!response.ok) {
  ...
  async function loadTradeHistory(signal?: AbortSignal) {
    const response = await fetch('/api/thumper/trade-history?limit=12', {
      credentials: 'include',
      signal,
    })
    if (!response.ok) {
  ...
  async function loadMessages(signal?: AbortSignal) {
    const response = await fetch('/api/thumper/messages?limit=10', {
      credentials: 'include',
      signal,
    })
    if (!response.ok) {
  ...
  async function loadResources(signal?: AbortSignal) {
    const response = await fetch('/api/thumper/resources', {
      credentials: 'include',
      signal,
    })
    if (!response.ok) {
  ...
  async function loadAnalytics(signal?: AbortSignal) {
    const response = await fetch('/api/thumper/site-analytics', {
      credentials: 'include',
      signal,
    })
    if (!response.ok) {
  ...
  async function loadJewelryLibrary(query: string, signal?: AbortSignal) {
    ...
    const response = await fetch(
      `/api/thumper/jewelry-library?query=${encodeURIComponent(trimmed)}&limit=16`,
      {
        credentials: 'include',
        signal,
      },
  ...
  async function handleUnsubscribe(
    ...
    try {
      const response = await fetch('/api/thumper/customer-audience', {
        method: 'POST',
        credentials: 'include',
  ...
  async function handleSendEmail() {
    ...
    try {
      const response = await fetch('/api/thumper/send-email', {
        method: 'POST',
        credentials: 'include',
        headers: { 'content-type': 'application/json' },
        body: JSON.stringify({
  ...
  async function handleQuickAddListing() {
    ...
    try {
      const response = await fetch('/api/thumper/trade-board', {
        method: 'POST',
        credentials: 'include',
        headers: { 'content-type': 'application/json' },
        body: JSON.stringify({
  ...
  async function handleTradeRequestDecision(
    ...
    try {
      const response = await fetch('/api/thumper/trade-requests', {
        method: 'POST',
        credentials: 'include',
        headers: { 'content-type': 'application/json' },
        body: JSON.stringify({
  ...
  async function handleAddFromLibrary(itemNumber: string) {
    ...
    try {
      const response = await fetch('/api/thumper/jewelry-library', {
        method: 'POST',
        credentials: 'include',
        headers: { 'content-type': 'application/json' },
        body: JSON.stringify({
  ...
  async function handleMarkMessageRead(messageId: string) {
    ...
    try {
      const response = await fetch('/api/thumper/messages', {
        method: 'POST',
        credentials: 'include',
        headers: { 'content-type': 'application/json' },
        body: JSON.stringify({
