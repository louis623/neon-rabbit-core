...
- [ ] **Restore Supabase CLI auth/linking for Sparkle Suite** - remote schema blocker was cleared manually, but CLI still needs auth/link cleanup so future migrations can use `supabase db push` instead of dashboard SQL.
