...
- Latest local signed-in UI alignment: July 3 A/B/C mobile app preview is now the active signed-in UI reference; local verification passed with lint, full tests, build, smoke, and signed-in screenshot review. Deployment/live smoke is the next closeout step.
