...
- [ ] **Audit Vercel automatic Git deployment creation** - August 17 push for `62263b35` unexpectedly created Git-sourced production deployment `dpl_9Q6b18uhJiLEog9UASNBALx75W8W` even though policy says `gitProviderOptions.createDeployments` is disabled. It was unaliased and the manually deployed exact tip `dpl_J7VDyXPynjJntQtX5Kn95QABA3qW` is the actual release. Inspect configuration/audit history before the next app push; do not re-enable or change it without Louis's approval.
