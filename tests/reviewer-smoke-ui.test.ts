...
describe('reviewer smoke UI wiring', () => {
  ...
  it('lets the Nic-Nac workspace own its Concept 1 app chrome', () => {
    ...
    expect(dashboardPlaceholder).not.toContain('function WorkspaceAppHeader')
    expect(dashboardPlaceholder).not.toContain('Ask Nic-Nac anything...')
    expect(dashboardPlaceholder).not.toContain('aria-label="Go to Nic-Nac home"')
    ...
    expect(dashboardPlaceholder).not.toContain('className={styles.appProfile}')
  })
