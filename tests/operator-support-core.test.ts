...
describe('operator support core security contracts', () => {
  it('normalizes only known, unique, deny-by-default capabilities', () => {
    ...
    expect(hasSupportCapability(DEFAULT_OPERATOR_SUPPORT_CAPABILITIES, 'messages.manage')).toBe(true)
    expect(hasSupportCapability(DEFAULT_OPERATOR_SUPPORT_CAPABILITIES, 'communications.manage')).toBe(true)
    expect(hasSupportCapability(DEFAULT_OPERATOR_SUPPORT_CAPABILITIES, 'nic_nac.use')).toBe(true)
    expect(hasSupportCapability(DEFAULT_OPERATOR_SUPPORT_CAPABILITIES, 'live_queue.view')).toBe(true)
