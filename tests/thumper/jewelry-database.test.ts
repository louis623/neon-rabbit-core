// Unit tests for the search_jewelry_database Thumper tool handler.
//
...
// flatten shape, and ServiceError → ThumperToolError translation are
// exercised end-to-end. Mock paths exactly match the imports in
// lib/thumper/tools/search-jewelry-database.ts.
...
import { makeSearchJewelryDatabaseTool, searchJewelryDatabaseTool } from '@/lib/thumper/tools/search-jewelry-database'
...
describe('search_jewelry_database — flattened structured output', () => {
  ...
  it('exposes readOnly: true on the registered ToolDefinition', () => {
    // readOnly lives on the exported ToolDefinition (lib/thumper/tools/types.ts:15),
